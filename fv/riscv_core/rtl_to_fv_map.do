...
# Generated on: Tue Nov 26 22:59:09 EST 2024 (Wed Nov 27 03:59:09 UTC 2024)
...
set_log_file fv/riscv_core/rtl_to_fv_map.log -replace
...
set env(CDN_SYNTH_ROOT) "/CMC/tools/cadence/GENUS21.10.000_lnx86/tools.lnx86"
set CDN_SYNTH_ROOT      "/CMC/tools/cadence/GENUS21.10.000_lnx86/tools.lnx86"
set env(CW_DIR) "/CMC/tools/cadence/GENUS21.10.000_lnx86/tools.lnx86/lib/chipware"
set CW_DIR      "/CMC/tools/cadence/GENUS21.10.000_lnx86/tools.lnx86/lib/chipware"

# default is to error out when module definitions are missing
set_undefined_cell black_box -noascend -both

add_search_path /CMC/kits/GPDK45/gsclib045/gsclib045/timing /CMC/kits/GPDK45/gsclib045/gsclib045/qrc/qx /CMC/kits/GPDK45/gsclib045/gsclib045/lef -library -both
read_library -liberty -both /CMC/kits/GPDK45/gsclib045/gsclib045/timing/slow_vdd1v0_basicCells.lib
...
add_search_path /export/tmp/8304_8/Labs/lab2/sources -design -golden
read_design -rangeconstraint -configuration  -enumconstraint -golden -lastmod -noelab   /export/tmp/8304_8/Labs/lab2/sources/riscv_pkg.vhd  /export/tmp/8304_8/Labs/lab2/sources/riscv_halfadder.vhd  /export/tmp/8304_8/Labs/lab2/sources/riscv_adder.vhd  /export/tmp/8304_8/Labs/lab2/sources/riscv_alu.vhd  /export/tmp/8304_8/Labs/lab2/sources/riscv_pc.vhd  /export/tmp/8304_8/Labs/lab2/sources/riscv_rf.vhd  /export/tmp/8304_8/Labs/lab2/sources/riscv_decoder.vhd  /export/tmp/8304_8/Labs/lab2/sources/riscv_DMEM.vhd  /export/tmp/8304_8/Labs/lab2/sources/riscv_ex.vhd  /export/tmp/8304_8/Labs/lab2/sources/riscv_fetch.vhd  /export/tmp/8304_8/Labs/lab2/sources/riscv_me.vhd  /export/tmp/8304_8/Labs/lab2/sources/riscv_predecode.vhd  /export/tmp/8304_8/Labs/lab2/sources/riscv_id.vhd  /export/tmp/8304_8/Labs/lab2/sources/riscv_wb.vhd  /export/tmp/8304_8/Labs/lab2/sources/riscv_core.vhd -vhdl 2008
elaborate_design -golden -root {riscv_core} -rootonly 
...
#---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------  
#  1      i_scan_en                      shift_enable     true       false       port        none                       false                 true          auto       
#  2      i_test_mode                    test_mode        true       false       port        none                       false                 true          auto       
#  3      i_rstn                         test_mode        false      false       port        none                       false                 false         auto       
#--------------------------------------------------------------------------------------------------------------------------------------------------------------------------  
...
#          Please review the constraints to ensure they are all expected
#          and appropriate.
add_pin_constraints 0 {i_scan_en} -golden
add_pin_constraints 0 {i_test_mode} -golden
add_pin_constraints 0 {i_scan_en} -revised
add_pin_constraints 0 {i_test_mode} -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/riscv_core/rtl_to_fv_map.log
}
